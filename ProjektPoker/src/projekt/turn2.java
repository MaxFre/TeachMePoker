 ...
 * Turn2 f�r AI med f�rb�ttrad kod
 * Som ska implementeras f�r turn1 ocks�.
 * Ändra det som är markerat i Cards för att få detta att funka. 
 * 
 *
 */
...
public class turn2 {
	...
	public turn2(String card1 , String card2, String card3, String card4, String card5){   // har strings f�r senare versioner. INget som anv�nds nu
...
//		System.out.println("pairs - " + pairs);
	...
	public static void main(String [] args){
		turn2 run = new turn2(null, null, null, null, null);    //har flera nulls f�r framtida versioner d�r jag f�r in v�rden via dem.
	}
