...
/**
 * 
 * @author Max Frennessen Räknar du vad AI bör göra när den har 5 kort. 24-03-17
 */
public class TurnTwo implements AICalculations {
  ...
  public void decide() {
    ...
    // }
    //
    // if(likelyhood>=roll && aiPot<toBet){ //om toBet större än pot och och likelyhood större än
    // roll, all in.
    // toDO = "All-in,"+aiPot;
    // aiPot-=aiPot;
    // }
