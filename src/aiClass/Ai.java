...
/**
 * 
 * @author Max Frennessen Huvudklass f�r AI-spelaren som beroende p� turn startar en AI utr�kning
 *         och skickar svar till controller p� vad AI:n kommer g�ra p� dess tur. 24-03-17
 */
public class Ai {
  ...
  private ArrayList<String> aiCards = new ArrayList<String>(); // Lista som l�gger till alla kort
  ...
  public Ai(int aiPot) { // F�R IN V�RDE H�R FR�N CONTROLLER, VET INTE HUR �N.
    ...
    if (testAI == 0) {
      for (int i = 0; i < 2; i++) { // L�gger till kort till ArrayList som skickas till constructor.
