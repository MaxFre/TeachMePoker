 ...
 * 
 * @author Max Frennessen 24-03-17
 */
...
public interface AICalculations {
  ...
  /**
   * 
   * @param aiCards - ArrayList som består av korten som är aktiva får AIn för att räkna ut ett
   *        beslut.
   */
  ...
  /**
   * 
   * @return -returns true or false beroende om korten har ett högt värde tillsammans.
   */
  ...
  /**
   * 
   * @return - returns true or false beroende om korten har samma färg.
   */
  boolean checkSuit();
