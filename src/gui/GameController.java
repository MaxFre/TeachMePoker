...
public class GameController {
	 ...
	 * 
	 * @param position
	 *            Position Position on the screen (0-4).
	 * @param state
	 *            The state can either be inactive (folded/lost), idle (waiting
	...
	/**
	 * Disables all buttons and shows player-frame's action as call, and the
	 * called amount. Calculates and withdraws amount from player-pot.
	 */
	public void playerCall() {

		disableButtons();
		System.out.println("Player call");
		this.playerPot -= (spController.getCurrentMaxBet() - alreadyPaid); // Player's
																			// pot
																			// -
																			// (Current
																			// maxbet
																			...
																			// PLAYER'S
																			// POT
		this.alreadyPaid += (spController.getCurrentMaxBet() - alreadyPaid); // Already
																				// paid
																				// +
																				// (Current
																				// maxbet
	...
	/**
	 * Disables all buttons and shows player-frame's action as raise, and the
	 * raised amount. Calculates and withdraws amount from player-pot and
	 * adjusts already paid.
	 */
	...
	/**
	 * Sets the slider's min and max values based on the player-pot. Sets
	 * minimum sliderValue based on BigBlind.
	 */
	...
	/**
	 * Places the AI-players in the correct position depending on chosen number
	 * of players.
	 * 
	 * @param aiPlayers
	...
	public void aiAction(int currentAI, String decision) {
		...
		// System.out.println("Current position: " + currentAIPosition + " SET:
		// " + setOfPlayers + "
		// currentAI: " + currentAI + " prevActivePlayer: " + prevPlayerActive +
		// " currentAIPosition: "
		// + currentAIPosition);
